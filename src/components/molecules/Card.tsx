      ...
      {assetContainer?.asset && (
        <div className="relative h-48 w-full">
          <Image
            ...
            alt={
              assetContainer.asset.description || title.content || "Card image"
            }
            fill
      ...
      <div className="p-6 flex flex-col flex-grow">
        <div className="flex flex-wrap gap-2 mb-3">
          {badges?.map((badge, index) => (
            <span
              key={index}
              className="text-xs font-semibold px-2 py-1 bg-blue-50 text-blue-600 rounded"
            >
              {badge}
            </span>
          ))}
        ...
        {title && (
          <Heading
            ...
            type={(title.type || "h3") as HeadingType}
